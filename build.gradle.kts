...
dependencies {
    ...
    // 优化的JavaCV依赖 - 只包含必要的组件和Windows x64平台
    "downloadLibs"("org.bytedeco:javacv:1.5.9")
    "downloadLibs"("org.bytedeco:javacpp:1.5.9")
    "downloadLibs"("org.bytedeco:javacpp:1.5.9:windows-x86_64")
    // 只包含必要的FFmpeg组件
