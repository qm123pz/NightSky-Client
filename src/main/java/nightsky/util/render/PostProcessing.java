...
import nightsky.util.shader.BlurShader;
...
public class PostProcessing {
    ...
    public static void drawBlur(float x, float y, float x2, float y2, Supplier<Runnable> maskDrawer) {
        ...
        if (!nightsky.module.modules.render.PostProcessing.isBlurEnabled()) {
            return;
        }
        ...
        float strength = nightsky.module.modules.render.PostProcessing.getBlurStrength();
    ...
    public static Framebuffer beginBloom() {
        if (!nightsky.module.modules.render.PostProcessing.isBloomEnabled()) return null;
    ...
    public static void endBloom(Framebuffer bloomBuffer) {
        ...
        BloomShader.renderBloom(bloomBuffer.framebufferTexture, nightsky.module.modules.render.PostProcessing.getBloomIterations(), nightsky.module.modules.render.PostProcessing.getBloomOffset());
    }
}
