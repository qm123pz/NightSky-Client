package nightsky.util;

import nightsky.NightSky;
import nightsky.management.RotationState;
import nightsky.module.modules.movement.TargetStrafe;
...
public class MoveUtil {
    ...
    public static float adjustYaw(float yaw, float forward, float strafe) {
        TargetStrafe targetStrafe = (TargetStrafe) NightSky.moduleManager.modules.get(TargetStrafe.class);
