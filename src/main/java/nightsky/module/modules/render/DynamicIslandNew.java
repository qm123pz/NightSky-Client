...
import nightsky.module.modules.render.dynamicisland.notification.Notification;
...
public class DynamicIslandNew extends Module {
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        Scaffold scaffoldModule = (Scaffold) NightSky.moduleManager.getModule("Scaffold");
        ...
        String middleTextClient = NightSky.clientName + NightSky.clientVersion;
        ...
        if (!showToggle && normalTextAlpha > 0.01f) {
            ...
            CustomFontRenderer.drawString(NightSky.clientName, midX, textY, w, font);
            float namePartW = CustomFontRenderer.getStringWidth(NightSky.clientName, font);
            CustomFontRenderer.drawString(NightSky.clientVersion, midX + namePartW, textY, g, font);
        }
        ...
        if (scaffoldMix > 0.0f) {
            ...
            if (uiAlpha > 0.01f && fillW > 0.5f) {
                nightsky.module.modules.render.Interface ui = (nightsky.module.modules.render.Interface) NightSky.moduleManager.getModule("Interface");
                ...
                if (nightsky.module.modules.render.PostProcessing.isNewDynamicIslandBloomFromItSelf()) {
                    ...
                    Framebuffer pb = BloomShader.beginFramebuffer();
                    RenderUtil.drawRoundedRect(barLeft, barY, fillW, barH, 5f, nightsky.module.modules.render.PostProcessing.getBloomColor());
                    mc.getFramebuffer().bindFramebuffer(false);
                    BloomShader.renderBloom(pb.framebufferTexture, 2, 1);
                }
