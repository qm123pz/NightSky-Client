...
public class KillAuraB extends Module {
    ...
    public KillAuraB() {
        ...
        this.autoBlockRequirePress = new BooleanValue("auto-block-require-press", false);
        this.autoBlockCPS = new FloatValue("auto-block-aps", 10.0F, 1.0F, 20.0F);
        this.autoBlockRange = new FloatValue("auto-block-range", 6.0F, 3.0F, 8.0F);
        ...
        this.moveFix = new ModeValue("move-fix", 1, new String[]{"NONE", "SILENT", "STRICT"});
        this.smoothing = new PercentValue("smoothing", 0);
        this.angleStep = new IntValue("angle-step", 90, 30, 180);
        this.throughWalls = new BooleanValue("through-walls", true);
        this.requirePress = new BooleanValue("require-press", false);
        this.allowMining = new BooleanValue("allow-mining", true);
        this.weaponsOnly = new BooleanValue("weapons-only", true);
        ...
        this.showTarget = new ModeValue("show-target", 0, new String[]{"NONE", "DEFAULT"});
        this.debugLog = new ModeValue("debug-log", 0, new String[]{"NONE", "HEALTH"});
    }
